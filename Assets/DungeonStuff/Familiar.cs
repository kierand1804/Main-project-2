...
public class Familiar : MonoBehaviour
{
    ...
    public FamiliarDataScript familiar;
    ...
    private void Update()
    {
        ...
        familiar.speed = player.GetComponent<MovementBasic1>().speed - 1f;
    }
    void Shoot(float x, float y)
    {
        GameObject projectile = Instantiate(familiar.bulletPrefab, transform.position, Quaternion.identity) as GameObject;
        ...
        projectile.GetComponent<Rigidbody2D>().velocity = new Vector2(posX, posY);
    }
}
